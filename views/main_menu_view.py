...
class MainMenuView:
    ...
    def display_main_menu_intro():
        ...
        print("\n" * 100)
        print(ansify("bld_it(    ~~~~~~~~~~~) it_ttl( 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 )bld_it( ~~~~~~~~~~~~~~)"
    ...
    def display_main_menu():
        """Displays the main menu."""
        print("\n" * 100)
        print(ansify("      bld_it(~~~~~~~~~) ttl_blu(⏐ 𝗖𝗵𝗲𝘀𝘀𝗨𝗽⬆︎ ⏐) bld_it(~~~~~~~~~~)\n\n\n"
              "\n      ttl_blu(𝟷.) Menu bld(TOURNOIS)"
              "\n      ttl_blu(𝟸.) Menu bld(JOUEURS)"
              "\n      ttl_blu(𝟹.) bld(RAPPORTS)\n\n"
              "\n       ch_up(Q. Quitter)\n\n"))
