...
class TournamentManager:
    ...
    def load_all(self):
        ...
        try:
            ...
            for t_data in data:
                ...
                if players_data:
                    new_tournament.players = self.recreate_players(players_data)
                players_by_id = {p.chess_id: p for p in new_tournament.players}
                rounds_data = t_data.get("rounds", [])
                if rounds_data:
                    new_tournament.rounds = self.recreate_rounds_and_matches(rounds_data, new_tournament, players_by_id)
    ...
    def save_all(self):
        ...
        serialize_tournaments(self.tournaments)
    ...
    def recreate_rounds_and_matches(rounds_data: dict, tournament, players_by_id: dict):
        ...
        for round_data in rounds_data:
            ...
            for match_d in round_data.get("matches", []):
